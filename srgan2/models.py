...
class GeneratorResNet1(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, n_residual_blocks=9):    #1 8 10 , 9
        ...
        for _ in range(n_residual_blocks):
            model += [ResidualBlock1(out_features)]
...
class GeneratorResNet2(nn.Module):
...
class Discriminator(nn.Module):
    def __init__(self, input_shape):
        ...
        patch_h, patch_w = math.ceil(in_height / 2 ** 2), math.ceil(in_width / 2 ** 2)
        self.output_shape = (1, patch_h, patch_w)# 1 15 12
